  ...
  return (
    <>
      <div className="footer">
        <div className="red-Pablo mt-3">
          <p>¡Contacta a Pablo!</p>
          <a
            href="https://www.linkedin.com/in/pablo-g%C3%B3mez-601868288/"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/Pablotesaurio"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://github.com/Pablitobellakito"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="red-Alfonso mt-3">
      ...
      <div className="fin">
        <p className="mt-3">
          ¡Gracias por visitar nuestra página! todos los derechos están
          resevados
        </p>
      </div>
    </>
